...
def test_real_file():
    ...
    # 测试文件路径
    test_file = Path("kg/data_process/extracted_entities/data/fixed_xml/2010/2010_Aurora_HBGARY_DRAFT_06a0673a.xml")
    # 如果文件不存在，尝试使用绝对路径
    if not test_file.exists():
        test_file = Path(__file__).parent / "data/fixed_xml/2010/2010_Aurora_HBGARY_DRAFT_06a0673a.xml"
