...
def main():
    ...
    group.add_argument('--dir', help='要修复的XML文件目录',default="kg/data_process/extracted_entities/data")
    parser.add_argument('--output', help='输出路径',default="kg/data_process/extracted_entities/data/fixed_xml")
